...
The drawings and schematics below (phase diagram, vessel cross-section, system block diagram, refrigeration cascade, cycle profile, P&ID, control architecture, and ISA-88 batch structure) are conceptual/explanatory originals created for this package:
